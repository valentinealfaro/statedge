...
// Unified StatEdge filter chip vocabulary — same six chips on every
// sport's Compare page. Predicate against the player's TOP line.
...
const FILTER_TOOLTIPS: Record<FilterTag, string> = {
  ...
  momentum:   'Player\'s top play scores ≥65 on the L2 momentum composite — recent form trending up sharply.',
};
